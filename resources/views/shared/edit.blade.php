                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mt-4">
                            ...
                            <input id="publish" name="ispublish" type="checkbox" {{ $blog->ispublish ? 'checked' : '' }}
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <x-trix-input id="content" name="content"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{!! $blog->content !!}"></x-trix-input>
                            </div>
                            ...
                            <select id="category" name="category_id"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        {{ $category->id == optional($blog)->category_id ? 'selected' : '' }}>
